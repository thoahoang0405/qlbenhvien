    ...
    <div class="row ">
        ...
        <div class="col-md-12">
            <div class="row">
                ...
                <div class=" text-end  ">
                    <div class="row">
                        ...
                        <button class="col-md-1  text-center btn-dark"> <a href="./kqxn.html" class="text-decoration-none text-white"> quay lại</a></button> 
            ...
            <div class="row">
                ...
                <div class=" mt-3 ms-3 btn btn-outline-info col-md-2"> <a href="./themketqua.html" style="text-decoration: none; font-size: 20px; color: black" >Thêm Kết Quả</a></div>
            </div>
            <div class="row mt-5">
