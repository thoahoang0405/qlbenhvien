<?php
    ...
    if(isset($_POST['btnSignIn'])){
        ...
        $sql = "SELECT * FROM letan WHERE maletan = '$maletan' AND matkhau ='$pass'";
        ...
        if(mysqli_num_rows($result) > 0){
            ...
            header("location:../../UI/letan/admin.php"); //Chuyển hướng về Trang quản trị
        }else{
            $error = "Bạn nhập thông tin tài khoản hoặc mật khẩu chưa chính xác";
            header("location: ../../UI/letan/login.php?error=$error"); //Chuyển hướng, hiển thị thông báo lỗi
        }

        // Bước 03: Đóng kết nối
        mysqli_close($conn);
    }else{
        header("location:../../UI/letan/login.php");
    }
?>
