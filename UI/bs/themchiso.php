...
<div class="container-fluid loginbs  pb-5">
    <div class="row ">
        ...
        <div class="col-md-12">
            ...
            <form action="../../BusinessLogic/bs/process_themchiso.php"  method="post" style="margin-left: 200px;font-weight:700 ">
            <div class="row mt-5 ">
                    ...
                    <div class="mb-3">
                      ...
                      <input  type="text" class="form-control " name="txtHA"  style="width: 350px" required>
            ...
            <div class="row ">
                    ...
                    <div class="mb-3">
                      ...
                      <input  type="text" class="form-control " name="txtNT"  style="width: 350px" required>
                    ...
                    <div class="mb-3">
                      ...
                      <input  type="text" class="form-control " name="txtNM"  style="width: 350px" required>
