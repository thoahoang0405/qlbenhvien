    ...
    <div class="row ">
        ...
        <div class="col-md-10 mt-5">
            ...
            <div class="col-md-2"></div>
                ...
                <div class="col-md-3 "><img src="../assets/img/check02.gif" alt=""  style="width:  400px; "></div>
                <div class="col-md-5 ms-2 " style="font-size: 50px; margin:100px; font-weight:700;">Thêm Thành Công!</div>
