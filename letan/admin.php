            ...
            <table class="table bg-white" >
                <thead> 
                    ...
                    <th scope="col">Mã bệnh nhân</th>
                        ...
                        <th scope="col">Lý do vào viện</th>
                        <th scope="col">Ngày khai báo</th>
                        <th scope="col">Quá trình bệnh lý</th>
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $sql = "SELECT benhnhan.mabn,	matkhau,	tenbn,	gioitinh,	ngaysinh,	doituong,	sothebhyt,	thoihanthe,	tennguoinha,	stdnguoinha,	trangthai,	bacsiphutrach,	ngaynhapvien,lydovaovien,ngaykhaibao,quatrinhbenhly,tieusu
                         FROM benhnhan,lydovaovien
                         where benhnhan.mabn = lydovaovien.mabn ";
                    ...
                    ?>
                                ...
                                <th scope="row"><?php echo $row['mabn']; ?></th>
                                    ...
                                    <td><?php echo $row['lydovaovien']; ?></td>
                                    <td><?php echo $row['ngaykhaibao']; ?></td>
                                    <td><?php echo $row['quatrinhbenhly']; ?></td>
