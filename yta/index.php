        ...
        <div class="col-md-10">
            <div class="row">
                <div class=" text-secondary text-start mt-3 ms-4">
                    <h3>Xin Chào Y Tá <?php echo $row['ten'] ?></h3>
                     
                </div>
                <div class=" text-end  ">
                    <div class="row">
                        <span class="col-md-9"></span>
                        <a href="ttyta.php?id=<?php echo $row['mayta']; ?>" class="text-decoration-none col-md-2"><span class="  material-icons ">
                            account_circle
                            </span></a>
            ...
            <div class="row mt-5">
                ...
                <div class="col-md-5 ">
                   <button type="button" class="btn-info btnxem"> <a class="text-decoration-none text-white"  href="benhan.php?id=<?php echo $row['mayta']; ?>">Bệnh Án</a> </button>
                </div>
                <div class="col-md-5">
                   <button type="button" class="btn-info btnxem"> <a class="text-decoration-none text-white" href="donthuoc.php?id=<?php echo $row['mayta']; ?>">Đơn Thuốc</a> </button>
                </div>
            </div>         
         </div>       
            <!-- -->
