	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="col-md-4">
				...
				<div class="col-md-12" style=" margin: 40px;padding: 40px;font-size: 25px;">
					<tr>
						<td class="" style="margin:70px;">HƯỚNG ĐIỀU TRỊ</td>
						<td>
						<textarea rows="5" cols="50" name="huongdieutri" form="usrform" > <?php  echo $huongdieutri ?></textarea>
					</tr>
				</div>
